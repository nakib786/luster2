...
import ProductStorefrontFallback from './ProductStorefrontFallback';
...
const ProductStorefront = () => {
  ...
  if (error && !products.length) {
    return <ProductStorefrontFallback />;
  }
      ...
      <section className="py-32 bg-gradient-to-br from-gray-50 via-white to-slate-100 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-gray-600 text-sm">Showing sample collections instead.</p>
